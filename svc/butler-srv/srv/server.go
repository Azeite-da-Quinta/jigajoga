...
import (
	"context"
	"fmt"
	"github.com/Azeite-da-Quinta/jigajoga/libs/go/handlers"
	"github.com/Azeite-da-Quinta/jigajoga/libs/go/middleware"
...
func (s *Server) setupRoutes(
	...
	mux.HandleFunc("POST /acquire", AcquireHandler)
	mux.HandleFunc("GET /refresh", RefreshHandler)
