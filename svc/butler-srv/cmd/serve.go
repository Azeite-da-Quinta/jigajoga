...
import (
	"github.com/Azeite-da-Quinta/jigajoga/svc/butler-srv/srv"
...
var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Serves the JWT  endpoint",
	Long: `This is the main command of the app.
It'll serve an HTTP and websocket server. Allows connecting players
to generate JWT token to authorize connection`,
