...
var rootCmd = &cobra.Command{
	Use:   "butler-srv",
	Short: "The Jigajoga JWT token producer and refrehser app",
	Long: `This app runs a JWT distribution server. 
Users may acquire tokens to get authorization and proper access to
the game servers.`,
...
func viperFromHome() {
	...
	viper.SetConfigName(".butler-srv.yml")
}
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "",
		"config file (default is $HOME/.butler-srv.yaml)")
